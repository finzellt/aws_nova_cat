...
class TestEsoXShooterProfileSnrExtraction:
    ...
    def test_snr_extracted_from_snr_reduced_column(self, profile: EsoXShooterProfile) -> None:
    ...
    def test_snr_header_fallback_when_no_column(self, profile: EsoXShooterProfile) -> None:
    ...
    def test_snr_header_fallback_adds_normalization_note(self, profile: EsoXShooterProfile) -> None:
    ...
    def test_snr_column_preferred_over_header(self, profile: EsoXShooterProfile) -> None:
    ...
    def test_snr_none_when_no_column_and_no_header(self, profile: EsoXShooterProfile) -> None:
