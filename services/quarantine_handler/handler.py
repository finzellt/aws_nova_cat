...
Description: Quarantine persistence and best-effort SNS notification
Workflows:   all workflows (shared)
Tasks:       QuarantineHandler
...
def _handle_quarantineHandler(event: dict, context: object) -> dict:
    """
    TODO: implement QuarantineHandler.
    ...
    """
    raise NotImplementedError("QuarantineHandler not yet implemented")
...
_TASK_HANDLERS: dict[str, Callable[[dict, object], dict]] = {
    "QuarantineHandler": _handle_quarantineHandler,
}
