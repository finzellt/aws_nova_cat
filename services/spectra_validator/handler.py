...
Description: FITS profile selection, IVOA-aligned normalization, validation result persistence
Workflows:   acquire_and_validate_spectra
Tasks:       CheckOperationalStatus, ValidateBytes, RecordValidationResult, RecordDuplicateLinkage
...
def _handle_validateBytes(event: dict, context: object) -> dict:
    """
    TODO: implement ValidateBytes.

    Receives the Step Functions task input event and the Lambda context.
    Must return a dict that will be used as the task output in the state machine.
    """
    raise NotImplementedError("ValidateBytes not yet implemented")


def _handle_recordValidationResult(event: dict, context: object) -> dict:
    """
    TODO: implement RecordValidationResult.

    Receives the Step Functions task input event and the Lambda context.
    Must return a dict that will be used as the task output in the state machine.
    """
    raise NotImplementedError("RecordValidationResult not yet implemented")


def _handle_recordDuplicateLinkage(event: dict, context: object) -> dict:
    """
    TODO: implement RecordDuplicateLinkage.

    Receives the Step Functions task input event and the Lambda context.
    Must return a dict that will be used as the task output in the state machine.
    """
    raise NotImplementedError("RecordDuplicateLinkage not yet implemented")
...
_TASK_HANDLERS: dict[str, Callable[[dict, object], dict]] = {
    ...
    "ValidateBytes": _handle_validateBytes,
    "RecordValidationResult": _handle_recordValidationResult,
    "RecordDuplicateLinkage": _handle_recordDuplicateLinkage,
}
