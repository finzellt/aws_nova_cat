...
Description: Bytes download, ZIP unpack, SHA-256 fingerprint, raw S3 write
...
def _handle_acquireArtifact(event: dict, context: object) -> dict:
    """
    TODO: implement AcquireArtifact.
    ...
    """
    raise NotImplementedError("AcquireArtifact not yet implemented")
...
_TASK_HANDLERS: dict[str, Callable[[dict, object], dict]] = {
    "AcquireArtifact": _handle_acquireArtifact,
}
