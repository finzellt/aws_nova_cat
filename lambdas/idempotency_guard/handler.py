...
Description: Workflow-level idempotency lock acquisition
Workflows:   all workflows (shared)
Tasks:       AcquireIdempotencyLock
...
def _handle_acquireIdempotencyLock(event: dict, context: object) -> dict:
    """
    TODO: implement AcquireIdempotencyLock.
    ...
    """
    raise NotImplementedError("AcquireIdempotencyLock not yet implemented")
...
_TASK_HANDLERS: dict[str, Callable[[dict, object], dict]] = {
    "AcquireIdempotencyLock": _handle_acquireIdempotencyLock,
}
